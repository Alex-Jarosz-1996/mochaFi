from backend.data.aus.websites import *
...
class AusStockClass:
    ...
    def display_all_metrics(self):
            ...
            for attr_name, attr_value in attributes.items():
                if isinstance(attr_value, (StockPriceMetrics, ValueMetrics, DividendMetrics, BalanceSheetMetrics, IncomeRelatedMetrics, CashFlowMetrics)):
                    print(f"\n{attr_name}:")
